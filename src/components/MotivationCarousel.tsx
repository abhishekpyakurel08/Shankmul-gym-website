            ...
            <div className="container mx-auto max-w-4xl text-center">
                ...
                <div className="relative h-48 flex items-center justify-center">
                    {quotes.map((quote, index) => (
                        ...
                        >
                            <h3 className="font-display text-2xl md:text-4xl font-bold text-slate-900 mb-6 leading-tight">
                                "{quote.text}"
                            </h3>
                ...
                <div className="flex justify-center gap-2 mt-8">
                    {quotes.map((_, index) => (
                        <button
                            ...
                            className={`w-2 h-2 rounded-full transition-all duration-300 ${index === current ? 'w-8 bg-brand-orange' : 'bg-slate-300 hover:bg-brand-orange/50'
                                }`}
